 ...
 */
export const ListMyPlayMatchHistoryResponseItem = zod.object({
  id: zod.number(),
  date: zod.string(),
  time: zod.string(),
  clubName: zod.string(),
...
export const ListMyPlayMatchHistoryResponse = zod.array(
  ListMyPlayMatchHistoryResponseItem,
);
 ...
 */
export const CompletePlayMatchParams = zod.object({
  id: zod.coerce.number(),
});

export const CompletePlayMatchBody = zod.object({
  setScores: zod.array(
    zod.object({
      teamA: zod.number(),
      teamB: zod.number(),
...
export const CompletePlayMatchResponse = zod.object({
  id: zod.number(),
  date: zod.string(),
  time: zod.string(),
  clubName: zod.string(),
